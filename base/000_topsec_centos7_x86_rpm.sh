...
baseurl=http://mirror.topsec.com.cn/centos/$releasever/os/$basearch/
#mirrorlist=http://mirrorlist.centos.org/?release=$releasever&arch=$basearch&repo=os
enabled=1
gpgcheck=1
gpgkey=http://mirror.topsec.com.cn/centos/RPM-GPG-KEY-CentOS-7

#released updates
[updates]
name=CentOS-$releasever - Updates
baseurl=http://mirror.topsec.com.cn/centos/$releasever/updates/$basearch/
...
baseurl=http://mirror.topsec.com.cn/centos/$releasever/extras/$basearch/
...
baseurl=http://mirror.topsec.com.cn/centos/$releasever/centosplus/$basearch/
...
baseurl=http://mirror.topsec.com.cn/centos/$releasever/sclo/$basearch/rh/
gpgcheck=0
enabled=1
...
baseurl=http://mirror.topsec.com.cn/centos/$releasever/sclo/$basearch/sclo/
gpgcheck=0
enabled=1
gpgkey=file:///etc/pki/rpm-gpg/RPM-GPG-KEY-CentOS-SIG-SCLo
